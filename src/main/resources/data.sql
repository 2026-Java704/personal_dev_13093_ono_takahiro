-- ユーザーテーブルデータ
INSERT INTO users(name, email, password) VALUES('ゲストユーザー', 'guest@example.com', 'guest1234');
...
---- レシピテーブル --
INSERT INTO recipes(user_id, category_id, name, recipe) VALUES(8, 1, '親子丼', E'\n1. 鶏肉を一口大に切る \n 2. 玉ねぎを薄切りにする \n 3. フライパンに油を熱し、鶏肉と玉ねぎを炒める \n 4. 水と調味料を加えて煮る \n5 . 卵を溶いて加え、半熟になるまで煮る \n6. ご飯の上にのせて完成');
...
INSERT INTO recipes(user_id, category_id, name, recipe) VALUES(8, 1, 'カツ丼', E'\n1. 豚肉に衣をつけて揚げる \n2. 玉ねぎを薄切りにする \n3. フライパンに油を熱し、玉ねぎを炒める \n4. 水と調味料を加えて煮る \n5. カツを加えて少し煮る　\n6.　卵を溶いて加え、半熟になるまで煮る \n7. ご飯の上にのせて完成');
...
INSERT INTO recipes(user_id, category_id, name, recipe) VALUES(8, 7, 'シーザーサラダ', E'\n1. レタスを洗ってちぎる \n2. クルトンを作る（パンを小さく切ってオーブンで焼く） \n3. ドレッシングを作る（ディジョンマスタード、ウスターソース、ライム果汁、アンチョビペースト、にんにく、卵黄、オリーブオイルを混ぜる） \n4. レタスとクルトンをボウルに入れてドレッシング混ぜる \n5. お皿に盛り付け、粉チーズをかけて完成');
INSERT INTO recipes(user_id, category_id, name, recipe) VALUES(7, 9, 'ガーリックトースト', E'\n1. バゲットを斜めに切る \n2. バターとローストしたにんにくを混ぜたものを塗る \n3. オーブンで200度で5分焼く \n4. パセリを振ってお皿に盛り付けて完成');
INSERT INTO recipes(user_id, category_id, name, recipe) VALUES(2, 8, '鯛の煮付け', E'\n1. 鯛を切り身にする \n2. 鍋に水、酒、みりん、醤油、砂糖を入れて火にかける \n3. 煮立ったら鯛を入れて中火で煮る \n4. 煮汁が少なくなったら火を止める \n5. お皿に盛り付けて完成');
INSERT INTO recipes(user_id, category_id, name, recipe) VALUES(8, 8, '鮭のムニエル', E'\n1. 鮭を切り身にする \n2. 塩コショウで下味をつける \n3. 小麦粉をまぶす \n4. フライパンにバターを熱し、鮭を両面焼く \n5. レモンを添えて完成');
INSERT INTO recipes(user_id, category_id, name, recipe) VALUES(4, 10, 'キムチ鍋', E'\n1. 鍋に水を入れて火にかける \n2. だしの素を加える \n3. キムチ、豚肉、豆腐、野菜を入れる \n4. 沸騰したら火を止める \n5. お椀に盛り付けて完成');
INSERT INTO recipes(user_id, category_id, name, recipe) VALUES(8, 11, 'お好み焼き', E'\n1. 具材を細かく切る \n2. 小麦粉、卵、水を混ぜて生地を作る \n3. 生地に具材を加えて混ぜる \n4. フライパンに油を熱し、生地を流し入れる \n5. 両面を焼いてお皿に盛り付ける \n6. お好みでソースやマヨネーズをかけて完成');
